...
set api_key "70b3d0be4b6d46fa969194438241812"
set city "Gij%C3%B3n"
...
set temp (echo $data | jq -r '.current.temp_c')
set feelslike (echo $data | jq -r '.current.feelslike_c')
...
sketchybar \
    --set $NAME icon="$icon" label="$temp°C" \
